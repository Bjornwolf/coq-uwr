...
Case "n = S n'".
  ...
  SCase "Proving H.".
    ...
    SSCase "k = S k'".
      ...
      reflexivity.
  rewrite H.
  assert(G: forall u v t : nat, u * (v + t) = u * v + u * t).
  SCase "Proving G.".
    intros u v t.
    induction u as [| u'].
    SSCase "u = 0".
    ...
    SSCase "u = S u'".
      ...
      rewrite plus_assoc.
      rewrite plus_assoc.
      assert(I: t + u' * v = u' * v + t).
        rewrite plus_comm.
        reflexivity.
      assert (J: forall a b c d : nat, a + b + c + d = a + (b + c) + d).
        intros a b c d.
        rewrite plus_assoc.
        reflexivity.
      rewrite J.
