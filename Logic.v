...
The _proof term_ for an implication [P -> Q] is a _function_ that takes evidence 
...
(** The meaning of a proposition is given by _rules_ and _definitions_
    ...
    - Sometimes a proposition is declared to be true without substantiating evidence.  
      Such propositions are called _axioms_.  
...
Theorem proj2 : forall P Q : Prop, 
  P /\ Q -> Q.
Proof.
  intros P Q H. inversion H as [HL HR]. apply HR.
Qed.
(** [] *)
...
Theorem iff_trans : forall P Q R : Prop, 
  (P <-> Q) -> (Q <-> R) -> (P <-> R).
Proof.
  intros P Q R H1 H2. inversion H1 as [HPQ HQP]. inversion H2 as [HQR HRQ].
  split.
...
Theorem or_distributes_over_and_2 : forall P Q R : Prop,
  (P \/ Q) /\ (P \/ R) -> P \/ (Q /\ R).
Proof.
  intros P Q R H. inversion H as [H1 H2]. inversion H1 as [HP | HQ].
  inversion H2 as [HP' | HR].
    left. apply HP.
    left. apply HP.
  inversion H2 as [HP' | HR].
    left. apply HP'.
...
Proof.
  intros P Q R. split.
    intros H. inversion H as [HP | HQR].
      split. left. apply HP. left. apply HP.
      inversion HQR as [HQ HR]. split. right. apply HQ. right. apply HR.
    intros H. inversion H as [HPQ HPR]. apply or_distributes_over_and_2.
      split. apply HPQ. apply HPR.
Qed.
(** [] *)
