...
Theorem rev_exercise1 : forall (l l' : list nat),
     ...
     l' = rev l.
Proof.
  intros l l'. intros H. rewrite H. symmetry. apply rev_involutive.
Qed.
(** [] *)
...
Example trans_eq_exercise : forall (n m o p : nat),
     ...
     (n + p) = (minustwo o). 
Proof.
  intros n m o p. intros H1 H2. apply trans_eq with (m:=m). apply H2. apply H1.
Qed.
(** [] *)
...
Example sillyex1 : forall (X : Type) (x y z : X) (l j : list X),
     ...
     x = y.
Proof.
  intros X. intros x y z l j. intros H1 H2. inversion H2. reflexivity.
Qed.
(** [] *)
...
Example sillyex2 : forall (X : Type) (x y z : X) (l j : list X),
     ...
     x = z.
Proof.
  intros X x y z l j. intros H1 H2. inversion H1.
Qed.
(** [] *)
...
Proof.
 intros n. simpl. destruct n. reflexivity. intros H. inversion H.
Qed.

Theorem beq_nat_0_r : forall n,
   beq_nat n 0 = true -> n = 0.
Proof.
  intros n. destruct n. reflexivity. simpl. intros H. inversion H. 
Qed.
(** [] *)
...
Proof.
  intros n. induction n as [| n']. 
    simpl. destruct m. reflexivity. simpl. intros H. inversion H.
    simpl. destruct m. simpl. intros H. inversion H. simpl. intros H.
...
Theorem index_after_last: forall (n : nat) (X : Type) (l : list X),
     ...
     index n l = None.
Proof.
  intros n X l. generalize dependent n. induction l as [|h t].
    simpl. reflexivity.
    simpl. intros n H. destruct n as [|n'].
      inversion H.
      inversion H. inversion H. apply IHt in H1. simpl. rewrite H2. apply H1.
Qed.
(** [] *)
...
Proof.
  ...
  induction l as [|h t].
    ...
    intros n. simpl. intros H. destruct n as [|n'].
      inversion H.
      inversion H. apply IHt in H1. rewrite H. rewrite H1. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  induction l1 as [|h t].
    intros l2 n. simpl. intros H. apply H.
    intros l2 n. simpl. intros H. destruct n as [|n'].
      inversion H.
      inversion H. apply IHt in H1. rewrite H1. rewrite H. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros X n l. generalize dependent n. induction l as [|h t].
    ...
    intros n. intros H. destruct n as [|n'].
      inversion H.
      inversion H. apply IHt in H1. simpl in H. rewrite H. simpl.
      assert(G: forall (T:Type) (x:T) (xs ys:list T), length (x :: (ys ++ xs)) = length (ys ++  x :: xs)).
        intros T x xs ys. generalize dependent x. generalize dependent xs.
        induction ys as [|y' ys'].
          simpl. reflexivity.
          simpl. intros xs x. rewrite <- IHys'. simpl. reflexivity. 
      rewrite <- G. simpl. rewrite H1. rewrite <- plus_n_Sm. reflexivity.
Qed.
(** [] *)
...
Theorem double_induction: forall (P : nat -> nat -> Prop), 
  ...
  forall m n, P m n.
Proof.
  intros P. intros H1 H2 H3 H4. intros m. induction m as [|m'].
    induction n as [|n']. 
      apply H1. apply H3 in IHn'. apply IHn'.
    induction n as [|n'].
      apply H2 in IHm'. apply IHm'.
      apply H4. apply IHm'.
Qed.
(** [] *)
...
Theorem combine_split : forall X Y (l : list (X * Y)) l1 l2,
  ...
  combine l1 l2 = l.
Proof.
  intros X Y l. induction l as [|(h1,h2) t].
    simpl. intros l1 l2. intros H. inversion H. reflexivity.
    simpl. intros l1 l2. intros H. inversion H. simpl. rewrite IHt. reflexivity.
    destruct (split t) as [x y]. simpl. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros f b. destruct (f true) eqn:Hft.
    destruct (f false) eqn:Hff.
      destruct b.
        rewrite Hft. rewrite Hft. apply Hft.
        rewrite Hff. rewrite Hft. apply Hft.
      destruct b.
        rewrite Hft. rewrite Hft. apply Hft.  
        rewrite Hff. rewrite Hff. apply Hff.
    destruct (f false) eqn:Hff.
      destruct b.
        rewrite Hft. rewrite Hff. apply Hft.
        rewrite Hff. rewrite Hft. apply Hff.
      destruct b.
        rewrite Hft. rewrite Hff. apply Hff.
        rewrite Hff. rewrite Hff. apply Hff.
Qed.
(** [] *)
...
Proof.
  intros X x1 k1 k2 f H. unfold override. destruct (beq_nat k1 k2) eqn:Hbnat.
    apply beq_nat_true in Hbnat. rewrite <- Hbnat. symmetry. apply H.
    reflexivity.
Qed.
(** [] *)
...
Theorem beq_nat_trans : forall n m p,
  ...
  beq_nat n p = true.
Proof. 
  intros n m p H1 H2. apply beq_nat_true in H1. apply beq_nat_true in H2.
  rewrite H1. rewrite <- H2.
  assert (bnt_mm: forall q : nat, beq_nat q q = true).
    intros q. induction q as [|q']. reflexivity. simpl. apply IHq'.
  apply bnt_mm.
Qed.
(** [] *)
...
Definition split_combine_statement : Prop :=
  forall (X Y : Type) (l : list (X * Y)), combine (fst (split l)) (snd (split l)) = l.

Theorem split_combine : split_combine_statement.
Proof.
  unfold split_combine_statement. intros X Y l. induction l as [| (hx, hy) l'].
    simpl. reflexivity.
...
Proof.
  intros X x1 x2 k1 k2 k3 f H. assert (bnt_mm: forall q : nat, beq_nat q q = true).
    intros q. induction q as [|q']. reflexivity. simpl. apply IHq'.
  unfold override. destruct (beq_nat k1 k3) eqn:Hk1k3.
    destruct (beq_nat k2 k3) eqn:Hk2k3. 
      apply beq_nat_true in Hk1k3. apply beq_nat_true in Hk2k3. rewrite Hk1k3 in H. 
      rewrite Hk2k3 in H. rewrite bnt_mm in H. inversion H.
      reflexivity.
    destruct (beq_nat k2 k3) eqn:Hk2k3.
      reflexivity. reflexivity.
Qed.
